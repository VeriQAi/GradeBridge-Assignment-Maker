      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
        <div className="flex items-center">
          <Link to="/" className="flex items-center gap-2">
            <div className="w-8 h-8 bg-academic-800 rounded-md flex items-center justify-center text-white font-serif font-bold">G</div>
            <h1 className="text-xl font-serif font-bold text-academic-900">GradeBridge<span className="font-light">Lite</span></h1>
          </Link>
        </div>
